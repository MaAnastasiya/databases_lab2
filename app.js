...
function reqPost(request, response) {
    if (request.method == 'POST') {
        ...
        request.on('end', function () {
            ...
            const sInsert = `INSERT INTO Sector (coordinates, light_intensity, foreign_objects_count, star_objects_count, unknown_objects_count, defined_objects_count, notes) 
                            VALUES ("${post['col1']}", 3.4, 5, 13, 2, 55, "Новый сектор")`;
